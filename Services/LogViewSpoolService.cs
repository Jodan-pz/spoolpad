...
namespace it.jodan.SpoolPad.Services {
	public class LogViewSpoolService : ISpoolerService {
		static readonly ILog _log = LogManager.GetLogger(typeof(LogViewSpoolService));
		...
		public string ObjectToString( object obj ) {
			...
			ObjectDumper.Write(obj, GraphDepth, writer);
